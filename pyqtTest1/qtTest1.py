...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "邮件批量发送"))
    def openfile(self):
        filePath, openfile_name = QFileDialog.getOpenFileName(self, '选择文件', '', 'Excelfiles(*.xlsx)')
        print(filePath)
        print(openfile_name)
        # 读取工作表
        str3 = filePath
        ...
        str = str(str3)
        str1 = str.split('/')[-1]
        workbook = openpyxl.load_workbook(str1)  # 返回一个workbook数据类型
